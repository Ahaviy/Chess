public class Pawn extends ChessPiece {
    ...
    public boolean canMoveToPosition(ChessBoard chessBoard, int line, int colum, int toLine, int toColumn) {
        ...
        if (colum == toColumn) {
            ...
            if (canAttackToPosition(chessBoard, line, colum, toLine, toColumn)) return true;
            return false;
        }
    }
        ...
        if ((colum - toColumn) == 1 || (toColumn - colum) == 1) {
            if (this.isWhite()) {
                ...
                if (line == 4 && toLine == 5 //Пешка стоит на 4-й линии
                        ...
                        && chessBoard.board[4][toColumn].getSymbol().equals("P") // это пешка
                        && !chessBoard.board[4][toColumn].isWhite() //она черная
                ...
                if (line == 3 && toLine == 2 //Пешка стоит на 3-й линии
                        ...
                        && chessBoard.board[3][toColumn].getSymbol().equals("P") // это пешка
